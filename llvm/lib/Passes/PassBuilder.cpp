...
static cl::opt<bool> s_obf_sym("sym", cl::init(false), cl::desc("Symbol Obfuscation"));
...
#include "PassRegistry.def"
  ...
  this->registerPipelineStartEPCallback(
      [](llvm::ModulePassManager &MPM,
        ...
        MPM.addPass(SymbolObfuscationPass(s_obf_sym));
